...
public class jsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Taxi");
        setContentView(R.layout.activity_jtos);
...
//        recyclerView. = layoutManager;
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText et_inDialog = new EditText(jsActivity.this);
                final AlertDialog.Builder builder = new AlertDialog.Builder(jsActivity.this);
                ...
                builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        reference.child("jsTime").updateChildren(t_map);
