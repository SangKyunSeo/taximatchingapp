...
public class jsChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jschat);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("From j_station to univ").child(str_room_name);
